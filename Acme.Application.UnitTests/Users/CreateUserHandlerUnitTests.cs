using Acme.Application.ServiceImpls.Accounts;
...
public class CreateUserHandlerUnitTests
{
    ...
    private readonly UpsertUserCommandHandler _handler;

    public CreateUserHandlerUnitTests()
    {
        _handler = new UpsertUserCommandHandler(_identityServiceMock.Object, _userRepositoryMock.Object,
    ...
    {
        // Arrange
        var command = new UpsertUserCommand(UserName, Mail, PhoneNumber, Password, FirstName, LastName, BirthYear,
